# Docker container for Audacious
[![Release](https://img.shields.io/github/release/jlesage/docker-audacious.svg?logo=github&style=for-the-badge)](https://github.com/jlesage/docker-audacious/releases/latest)
[![Docker Image Size](https://img.shields.io/docker/image-size/jlesage/audacious/latest?logo=docker&style=for-the-badge)](https://hub.docker.com/r/jlesage/audacious/tags)
[![Docker Pulls](https://img.shields.io/docker/pulls/jlesage/audacious?label=Pulls&logo=docker&style=for-the-badge)](https://hub.docker.com/r/jlesage/audacious)
[![Docker Stars](https://img.shields.io/docker/stars/jlesage/audacious?label=Stars&logo=docker&style=for-the-badge)](https://hub.docker.com/r/jlesage/audacious)
[![Build Status](https://img.shields.io/github/actions/workflow/status/jlesage/docker-audacious/build-image.yml?logo=github&branch=master&style=for-the-badge)](https://github.com/jlesage/docker-audacious/actions/workflows/build-image.yml)
[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg?style=for-the-badge)](https://paypal.me/JocelynLeSage)

This project provides a Docker container for [Audacious](https://audacious-media-player.org).
...
[![Audacious logo](https://images.weserv.nl/?url=raw.githubusercontent.com/jlesage/docker-templates/master/jlesage/images/audacious-icon.png&w=110)](https://audacious-media-player.org)[![Audacious](https://images.placeholders.dev/?width=288&height=110&fontFamily=monospace&fontWeight=400&fontSize=52&text=Audacious&bgColor=rgba(0,0,0,0.0)&textColor=rgba(121,121,121,1))](https://audacious-media-player.org)

Audacious is a free and open-source audio player software with a focus on low
resource use, high audio quality, and support for a wide range of audio formats.
...
Launch the Audacious docker container with the following command:

```shell
docker run -d \
    --name=audacious \
    -p 5800:5800 \
    -v /docker/appdata/audacious:/config:rw \
...
Where:
  ...
  - `/docker/appdata/audacious`: Stores the application's configuration, state, logs, and any files requiring persistency.
  - `/home/user`: Contains files from the host that need to be accessible to the application.
  - `/dev/sr0`: This is the Linux device file representing the optical drive.

Access the Audacious GUI by browsing to `http://your-host-ip:5800`.
...
services:
  audacious:
    image: jlesage/audacious
    ports:
      - "5800:5800"
    volumes:
      - "/docker/appdata/audacious:/config:rw"
...
[Releases]: https://github.com/jlesage/docker-audacious/releases
[Docker Hub]: https://hub.docker.com/r/jlesage/audacious/tags
...
container, it would proxy all HTTP requests for `audacious.domain.tld` to
...
server {
	...
	server_name audacious.domain.tld;

	location / {
		proxy_pass http://docker-audacious;
...
server {
	...
	location = /audacious {return 301 $scheme://$http_host/audacious/;}
	location /audacious/ {
		proxy_pass http://docker-audacious/;
		proxy_http_version 1.1;
		proxy_set_header Upgrade $http_upgrade;
...
| **Application version** label | Displays the version of Audacious integrated into Docker image. |
...
Any desktop notification generated by Audacious is forwarded to the
...
second, etc). To allow Audacious to access the first drive, use
this parameter:
...
[create a new issue](https://github.com/jlesage/docker-audacious/issues).
